...
public class LovesonglistBean {
    ...
    public LovesonglistBean() {}

    public LovesonglistBean(boolean ifcrator, String listid, String listname, String count, Bitmap coverImg, String creatorid, String creatorname) {
    ...
    protected LovesonglistBean(Parcel in) {
