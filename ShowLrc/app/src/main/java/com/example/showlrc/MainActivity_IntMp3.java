...
import com.example.showlrc.showlrc.lrc;
...
//              跳转至歌词页面
                ...
                intent2.setClass(MainActivity_IntMp3.this, com.example.showlrc.showlrc.lrc.class);

                //把数据封装至bundle对象中
                Bundle bundle2 = new Bundle();
                bundle2.putString("lyric",mDatas.get(currnetPlayPosition).lyric);
                Log.i(TAG,"lyric===="+mDatas.get(currnetPlayPosition).lyric.substring(0,30));
                bundle2.putString("path",mDatas.get(currnetPlayPosition).path);
                //把bundle对象封装至intent对象中
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    URL url = new URL("http://192.168.1.108:3000/search?keywords="+key+"&limit=3");
    ...
    public static void doJson(String json, List mDatas){
        ...
        try {
            ...
            for (int i=0;i<songs_array.length();i++){
                ...
                IntMusicBean intmusic = new IntMusicBean(songid,songname,singerid,singername,path,lyric,length);
