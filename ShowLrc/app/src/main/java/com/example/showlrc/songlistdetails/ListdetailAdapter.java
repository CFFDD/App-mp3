...
///////////////////////////
    ...
    public void onBindViewHolder(@NonNull ListdetailViewHolder holder, final int position) {
        ...
        holder.addtolist_details.setTag(position);
    ...
    class ListdetailViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageButton addtolist_details,addtolove_details;
        ...
        public ListdetailViewHolder(View itemView) {
            ...
            addtolist_details = itemView.findViewById(R.id.addtolist_details);
            addtolove_details= itemView.findViewById(R.id.addtolove_details);

            itemView.setOnClickListener(ListdetailAdapter.this);
            addtolist_details.setOnClickListener(ListdetailAdapter.this);
        ...
        if (ldOnItemClickListener != null) {
            switch (v.getId()) {
                default:
                    ...
                    break;
                case R.id.addtolist_details:
                    ldOnItemClickListener.onItemClick(v, ViewName.addtolist, position);
                    break;
