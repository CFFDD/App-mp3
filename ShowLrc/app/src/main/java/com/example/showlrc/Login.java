...
public class Login extends AppCompatActivity implements View.OnClickListener{
    ...
    private void ReadytoFunction() {
            ...
            bundle.putString("cookie",userBean.cookie);
                ...
                try {
                    ...
                    if (s != null) {
                        ...
                        try {
                            ...
                            Log.i(TAG, "开始获取cookie  !!!!!!!!!!!!!!!!!!!!");
                            /*String cookie =object.getString("cookie");
                            Log.i(TAG, "cookie==="+cookie+"        !!!!!!!!!!!!!!!!!!!!");
                            userBean.cookie=getFilename1(cookie);       //从cookie字段分离——获取令牌*/
                            userBean.cookie=object.getString("cookie");

                            Log.i(TAG, "userBean.cookie==="+userBean.cookie+"        !!!!!!!!!!!!!!!!!!!!");
    ...
    public static String getFilename1(String strFileName)//IndexOf找出M第一次出现的位置
    {
        int a = strFileName.indexOf("__csrf");
        return strFileName.substring(a+6,a+39);
    }
