...
public class MusiclistBean_collect {
    ...
    public MusiclistBean_collect() {}

    public MusiclistBean_collect(boolean ifcrator, String listid, String listname, String count, Bitmap coverImg, String creatorid, String creatorname) {
    ...
    protected MusiclistBean_collect(Parcel in) {
