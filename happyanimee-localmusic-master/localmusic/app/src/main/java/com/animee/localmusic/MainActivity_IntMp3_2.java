...
public class MainActivity_IntMp3_2 extends AppCompatActivity implements View.OnClickListener{
...
//                    此时没有播放音乐，点击开始播放音乐
    ...
    public static void query2(final IntMusicAdapter adapter) {
